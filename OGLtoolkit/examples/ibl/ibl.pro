...
HEADERS += \
    ...
    ImageLightingScene.h

OTHER_FILES += \
    bin/resources/shaders/renderCubemap.vert \
    bin/resources/shaders/renderCubemap.frag \
    bin/resources/shaders/iblLighting.vert \
    bin/resources/shaders/iblLighting.frag
